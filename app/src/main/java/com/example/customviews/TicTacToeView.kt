...
class TicTacToeView @JvmOverloads constructor(
    ...
    // when saved colors are changed to draw the field with new colors
    ...
    private fun initPaints() {
        ...
        player1Paint.color = sharedPreferences.getInt(PREF_COLOR_PLAYER_1, Color.BLUE)
        ...
        player2Paint.color = sharedPreferences.getInt(PREF_COLOR_PLAYER_2, Color.RED)
        ...
        gridPaint.color = sharedPreferences.getInt(PREF_COLOR_GRID, Color.GRAY)
    ...
    override fun onAttachedToWindow() {
        ...
        // start listening preference changing and field data changes
    ...
    override fun onDetachedFromWindow() {
        ...
        // stop listening preference changing and field data changes
        field?.listeners?.remove(listener)
